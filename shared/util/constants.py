...
EMAIL_VERIFICATION_LINK = '%s/onboarding/%s/verify?' + VERIFICATION_TOKEN_NAME + '=%s'
...
RESET_PASSWORD_VERIFICATION_LINK = '%s/account/%s/reset_password?' + VERIFICATION_TOKEN_NAME + '=%s'
